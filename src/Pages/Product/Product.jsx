...
const Product = () => {
    ...
    const { title, thumbnail, stock, rating, price,description } = product || {}
    console.log(product)
    return (
        <div className=''>
            <div className='flex h-screen items-center justify-center '>
                ...
                <div class="w-full  max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:border-gray-700">
                    <div className='h-72'>
                        <img class="p-8 h-64 w-full rounded-t-lg" src={thumbnail} />
                    </div>
                    <div class="px-5 pb-5">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Go Back</button>
